 ...
 * @author Tiago Dias
 */
public class EnviadosIntIpi extends javax.swing.JInternalFrame {
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into ipiacompanhamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de IPI informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de IPI informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de IPI informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update ipiacompanhamento set "
                        ...
                        con_ipi.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_ipi.statement.executeUpdate("delete from ipiacompanhamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnviadosIntIpi().setVisible(true);
            }
        });
    }
...
public void pegar_ultimo_registro(){
        ...
        con_ipi.executeSQL("select * from ipiacompanhamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_ipi.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_ipi.resultset.getString("Cod");
                
                data1 = con_ipi.resultset.getString("Data1Envio");
                data2 = con_ipi.resultset.getString("Data2Envio");
                data3 = con_ipi.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_ipi.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_ipi.resultset.next())
            modelo.addRow(new Object []{
                con_ipi.resultset.getString("Cod"),
                con_ipi.resultset.getString("DataAndamento"),
                con_ipi.resultset.getString("Data1Envio"),
                con_ipi.resultset.getString("Data2Envio"),
                con_ipi.resultset.getString("Data3Envio"),
                con_ipi.resultset.getString("Observacao"),
                con_ipi.resultset.getString("Usuario")});
                con_ipi.resultset.first();
    }catch(Exception erro){
