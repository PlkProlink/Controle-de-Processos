 ...
 * @author Tiago Dias
 */
public class EnviadosIntGps extends javax.swing.JInternalFrame {
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into gpsacompanamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de GPS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de GPS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de GPS informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update gpsacompanamento set "
                        ...
                        con_gps.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_gps.statement.executeUpdate("delete from gpsacompanamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnviadosIntGps().setVisible(true);
            }
        });
    }
...
public void pegar_ultimo_registro(){
        ...
        con_gps.executeSQL("select * from gpsacompanamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_gps.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_gps.resultset.getString("Cod");
                
                data1 = con_gps.resultset.getString("Data1Envio");
                data2 = con_gps.resultset.getString("Data2Envio");
                data3 = con_gps.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_gps.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_gps.resultset.next())
            modelo.addRow(new Object []{
                con_gps.resultset.getString("Cod"),
                con_gps.resultset.getString("DataAndamento"),
                con_gps.resultset.getString("Data1Envio"),
                con_gps.resultset.getString("Data2Envio"),
                con_gps.resultset.getString("Data3Envio"),
                con_gps.resultset.getString("Observacao"),
                con_gps.resultset.getString("Usuario")});
                con_gps.resultset.first();
    }catch(Exception erro){
