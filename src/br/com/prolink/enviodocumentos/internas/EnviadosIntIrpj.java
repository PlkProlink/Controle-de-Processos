 ...
 * @author User
 */
public class EnviadosIntIrpj extends EnviadosIntModelo{
    String campo1="IRPJacompanhamento", tabela1="irpjacompanhamento", tela1 = "Irpj";
    public EnviadosIntIrpj(){
        setTitle("Acompanhamento de Envios - Irpj");
    ...
    public static void main(String[] args){
        EnviadosIntModelo telaBoletos = new EnviadosIntIrpj();
