 ...
 * @author Tiago
 */
public class DocumentosIntFolha extends DocumentosIntModelo{
    
    String campo1="FolhadePagamentoDocumento", tabela1="folhadepagamentodocumento", tela1 = "Folha de Pagamento";
    
    public DocumentosIntFolha(){
        setTitle("Folha - Folha de Pagamento");
        
        super.inicializacao("FolhadePagamentoDocumento","folhadepagamentodocumento", "Folha de Pagamento");
    ...
    public static void main(String[] args){
        DocumentosIntModelo doc = new DocumentosIntFolha();
        doc.setVisible(true);
    }
    @Override
    public void enviar_label1(){
        Documentos.lbFolha1.setText(data1);
    }
    @Override
    public void enviar_label2(){
        Documentos.lbFolha2.setText(data2);
    }
    @Override
    public void enviar_label3(){
        Documentos.lbFolha3.setText(data3);
    }
    @Override
