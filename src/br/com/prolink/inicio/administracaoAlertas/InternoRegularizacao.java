 ...
 * @author User
 */
public class InternoRegularizacao extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lbArquivar = new javax.swing.JLabel();
        ...
        lbArquivar.setBackground(new java.awt.Color(250, 250, 250));
        lbArquivar.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        lbArquivar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbArquivar.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        lbArquivar.setOpaque(true);
        lbArquivar.setPreferredSize(new java.awt.Dimension(0, 22));
        ...
        jPDepartamentoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPDepartamentoLayout.createSequentialGroup()
                ...
                .addGroup(jPDepartamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lbArquivar, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        jPDepartamentoLayout.setVerticalGroup(
            ...
            .addGroup(jPDepartamentoLayout.createSequentialGroup()
                ...
                .addComponent(lbArquivar, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(223, 223, 223))
        );

        jLabel11.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel11.setText("Env.Termo para Comercial");

        jLabel12.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel12.setText("Arquivar Processo");

        jLabel1.setBackground(new java.awt.Color(250, 250, 250));
        jLabel1.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Regularização");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(!controle && documento==0){
            JOptionPane.showMessageDialog(null,"Não existem pendências do cliente "+
                    ProcessoLogado.getInstance().getProcesso().getCliente()+" \npara serem validadas para esse departamento!");
        }
        else{
            List <String> nova = new ArrayList<>();
            nova.add("");
            Relatorios relatorio = new Relatorios("Alerta", "Regularizacao", nova);
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        if(!jComboBox1.getSelectedItem().equals("Clique aqui para Ativar!")  &&
            ...
            regularizacao(""+ProcessoLogado.getInstance().getProcesso().getId());
    ...
    private javax.swing.JLabel lbArquivar;
    ...
    private void abrirRegularizacao(){
        Processo p = ProcessoLogado.getInstance().getProcesso();
        if(p==null){
            JOptionPane.showMessageDialog(null, "Para prosseguir ative um cadastro!");
            ...
            if(rs!=null){
                if(rs.next()){
                    ...
                    p.setAtributos(new String[]{
                        ...
                        rs.getString("Cliente"), rs.getString("Classificacao"),
                        rs.getInt("Situacao")==1?"Ativo":"Finalizado"
                    });
                }
            }
    ...
    public void regularizacao(String processo){
        ...
        String sql = "select B.AndamentoRegularizacao as GERAL," +
                    "A.AndamentoEnviarTernoReponsaParaComercial as TERMO," +
                    "A.AndamentoArquivarProcesso as ARQUIVAR " +
                    "from regularizacao as A " +
        ...
        try{
            ...
            if(rs!=null)
                while(rs.next()){
                    ...
                    lbArquivar.setText(rs.getString("ARQUIVAR"));
