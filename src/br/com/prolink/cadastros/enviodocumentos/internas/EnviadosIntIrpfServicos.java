...
public class EnviadosIntIrpfServicos extends javax.swing.JInternalFrame {
    ...
    public EnviadosIntIrpfServicos() {
        ...
        con_irpfserv = new Conexao();
        con_irpfserv.conecta();
        ...
        logb.setTela("Envio de Irpf Serviços");
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into irpfsobreservicotomadoacompanhamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de IRPF SERVIÇOS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de IRPF SERVIÇOS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de IRPF SERVIÇOS informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update irpfsobreservicotomadoacompanhamento set "
                        ...
                        con_irpfserv.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_irpfserv.statement.executeUpdate("delete from irpfsobreservicotomadoacompanhamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
...
public void pegar_ultimo_registro(){
        ...
        con_irpfserv.executeSQL("select * from irpfsobreservicotomadoacompanhamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_irpfserv.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_irpfserv.resultset.getString("Cod");
                
                data1 = con_irpfserv.resultset.getString("Data1Envio");
                data2 = con_irpfserv.resultset.getString("Data2Envio");
                data3 = con_irpfserv.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_irpfserv.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_irpfserv.resultset.next())
            modelo.addRow(new Object []{
                con_irpfserv.resultset.getString("Cod"),
                con_irpfserv.resultset.getString("DataAndamento"),
                con_irpfserv.resultset.getString("Data1Envio"),
                con_irpfserv.resultset.getString("Data2Envio"),
                con_irpfserv.resultset.getString("Data3Envio"),
                con_irpfserv.resultset.getString("Observacao"),
                con_irpfserv.resultset.getString("Usuario")});
                con_irpfserv.resultset.first();
    }catch(Exception erro){
