 ...
 * @author Tiago Dias
 */
public class EnviadosIntIrpfSalario extends javax.swing.JInternalFrame {
    ...
    public EnviadosIntIrpfSalario() {
        ...
        logb.setTela("Envio de Irpf Salario");
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into irpfsobresalarioacompanhamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de IRPF SALARIO informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de IRPF SALARIO informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de IRPF SALARIO informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update irpfsobresalarioacompanhamento set "
                        ...
                        con_irpfsal.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_irpfsal.statement.executeUpdate("delete from irpfsobresalarioacompanhamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnviadosIntIrpfSalario().setVisible(true);
            }
        });
    }
...
public void pegar_ultimo_registro(){
        ...
        con_irpfsal.executeSQL("select * from irpfsobresalarioacompanhamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_irpfsal.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_irpfsal.resultset.getString("Cod");
                
                data1 = con_irpfsal.resultset.getString("Data1Envio");
                data2 = con_irpfsal.resultset.getString("Data2Envio");
                data3 = con_irpfsal.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_irpfsal.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_irpfsal.resultset.next())
            modelo.addRow(new Object []{
                con_irpfsal.resultset.getString("Cod"),
                con_irpfsal.resultset.getString("DataAndamento"),
                con_irpfsal.resultset.getString("Data1Envio"),
                con_irpfsal.resultset.getString("Data2Envio"),
                con_irpfsal.resultset.getString("Data3Envio"),
                con_irpfsal.resultset.getString("Observacao"),
                con_irpfsal.resultset.getString("Usuario")});
                con_irpfsal.resultset.first();
    }catch(Exception erro){
