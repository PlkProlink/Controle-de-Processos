 ...
 * @author Tiago Dias
 */
public class EnviadosIntIcmsServicos extends javax.swing.JInternalFrame {
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into icmsacompanhamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de ICMS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de ICMS informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de ICMS informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update icmsacompanhamento set "
                        ...
                        con_icms.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_icms.statement.executeUpdate("delete from icmsacompanhamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnviadosIntIcmsServicos().setVisible(true);
            }
        });
    }
...
public void pegar_ultimo_registro(){
        ...
        con_icms.executeSQL("select * from icmsacompanhamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_icms.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_icms.resultset.getString("Cod");
                
                data1 = con_icms.resultset.getString("Data1Envio");
                data2 = con_icms.resultset.getString("Data2Envio");
                data3 = con_icms.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_icms.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_icms.resultset.next())
            modelo.addRow(new Object []{
                con_icms.resultset.getString("Cod"),
                con_icms.resultset.getString("DataAndamento"),
                con_icms.resultset.getString("Data1Envio"),
                con_icms.resultset.getString("Data2Envio"),
                con_icms.resultset.getString("Data3Envio"),
                con_icms.resultset.getString("Observacao"),
                con_icms.resultset.getString("Usuario")});
                con_icms.resultset.first();
    }catch(Exception erro){
