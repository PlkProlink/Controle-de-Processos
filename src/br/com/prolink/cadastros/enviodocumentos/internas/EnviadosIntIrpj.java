 ...
 * @author Tiago Dias
 */
public class EnviadosIntIrpj extends javax.swing.JInternalFrame {
    ...
    public EnviadosIntIrpj() {
        initComponents();
        
        con_irpj = new Conexao();
        con_irpj.conecta();
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into irpjacompanhamento "
                        ...
                        acao = "Inclusão";
                        descricao = "1º, 2º e 3º envio de IRPJ informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º e 2º envio de IRPJ informado";
                    ...
                    try{
                        ...
                        acao = "Inclusão";
                        descricao = "1º envio de IRPJ informado";
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update irpjacompanhamento set "
                        ...
                        con_irpj.statement.executeUpdate(sql);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(txtCodigo.getText().equals("")){
            ...
            if(escolha==JOptionPane.YES_OPTION){
                try{
                    int excluiu = con_irpj.statement.executeUpdate("delete from irpjacompanhamento where Cod="+txtCodigo.getText());
                    if(excluiu == 1){
                        String mensagem = "Atualizado com sucesso!";
                        lbMensagem.setText(mensagem);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnviadosIntIrpj().setVisible(true);
            }
        });
    }
...
public void pegar_ultimo_registro(){
        ...
        con_irpj.executeSQL("select * from irpjacompanhamento where NumeroProcesso='"+processo+"'");
        try {
            if(con_irpj.resultset.last()){
                String novocodigo , ndata1, ndata2, ndata3;
                
                novocodigo = con_irpj.resultset.getString("Cod");
                
                data1 = con_irpj.resultset.getString("Data1Envio");
                data2 = con_irpj.resultset.getString("Data2Envio");
                data3 = con_irpj.resultset.getString("Data3Envio");
                
                if(!"".equals(novocodigo) || novocodigo != null){
                    
                    txtCodigo.setText(novocodigo);
                    txtObservacao.setText(con_irpj.resultset.getString("Observacao"));
...
public void preencher_tabela(){
    ...
    try{
        while(con_irpj.resultset.next())
            modelo.addRow(new Object []{
                con_irpj.resultset.getString("Cod"),
                con_irpj.resultset.getString("DataAndamento"),
                con_irpj.resultset.getString("Data1Envio"),
                con_irpj.resultset.getString("Data2Envio"),
                con_irpj.resultset.getString("Data3Envio"),
                con_irpj.resultset.getString("Observacao"),
                con_irpj.resultset.getString("Usuario")});
                con_irpj.resultset.first();
    }catch(Exception erro){
...
public void enviar_label1(){
    DocumentosEnviados.lbIrpj1.setText(data1);
}
public void enviar_label2(){
    DocumentosEnviados.lbIrpj2.setText(data2);
}
public void enviar_label3(){
    DocumentosEnviados.lbIrpj3.setText(data3);
}
