...
import br.com.prolink.enviodocumentos.internas.AtualizacaoEnviados;
...
public class EnviadosIntModelo extends javax.swing.JInternalFrame {
    ...
    AtualizacaoEnviados at  = new AtualizacaoEnviados();
            ...
            JOptionPane.showMessageDialog(null, "3º data de envio não é permitido se a 1º e 2º não forem informadas");
                ...
                if(data1.trim().length()==10 
                    ...
                    try{
                        ...
                        String gry = "insert into boletoplkacompanhamento "
...
//                        at.atualizar_acompanhamento3(campo, tela);
            ...
            if(data1.trim().length()==10
                ...
                && data3.trim().length()==10){
                    try{
                        ...
                        String sql = "update boletoplkacompanhamento set "
...
//                        atualizar_acompanhamento1();
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        String tdata = (String)jTable.getValueAt(linha, 1);
        String tdata1 = (String)jTable.getValueAt(linha, 2);
        String tdata2 = (String)jTable.getValueAt(linha, 3);
        String tdata3 = (String)jTable.getValueAt(linha, 4);
        String obs = (String)jTable.getValueAt(linha, 5);
...
//        atualizar_acompanhamento1();
    ...
    /**
     * @return the campoEnviados
     */
    public String getCampoEnviados() {
        return campoEnviados;
    }

    /**
     * @param campoEnviados the campoEnviados to set
     */
    public void setCampoEnviados(String campoEnviados) {
        this.campoEnviados = "";
    }
