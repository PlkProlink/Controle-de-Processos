...
public class ListagemDAO {
    ...
    private Connection con;
        ...
        try{
            ...
            ps.setString(8, tabela.getQuemrecebeu());
            ps.setString(9, tabela.getDataRecebimento());
            ps.setString(10, tabela.getObservacao());
            ps.setString(14, tabela.getRecebido());
            ps.setInt(1, tabela.getCod());
        ...
        public List<ListagemBean> listarTodos() {

        String sql = sql = ListagemBean.comando;
