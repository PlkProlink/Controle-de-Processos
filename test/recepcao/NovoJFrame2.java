 ...
 * @author Tiago
 */
public class NovoJFrame2 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CalendarPane calendarPane1 = new com.michaelbaranov.microba.calendar.CalendarPane();
        calendarPane1.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                try{
                    Date data = calendarPane1.getDate();
        ...
        calendarPane1.addActionListener(new ActionListener() {
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoJFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoJFrame2().setVisible(true);
            }
        });
    }
