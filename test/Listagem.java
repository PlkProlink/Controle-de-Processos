...
public class Listagem extends javax.swing.JFrame {
    ...
    String para, recebido, departamento, usuario= "Ana";
    ...
    private void btnValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidarActionPerformed
        ...
        lb.setRecebido("S");
        lb.setDataRecebimento(String.valueOf(data));
...
//        situacao = "'S' or Recebido='N' ";
    ...
    private void btRelatorio1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRelatorio1ActionPerformed
        //envia comando para o metodo gerar relatorio dentro de listagem bean
...
public void verificarData(){
    if(check.isSelected()){
        if(txtData1.getText().trim().length()<10 || txtData2.getText().trim().length()<10){
            ...
            lb.bloquearRelatorio();
        }
        else{
            lb.tratarDatas(txtData1.getText(), txtData2.getText());
        }
    }
    else{
        lb.setPegaAno("");
